...
- **Race-level numbers live in the bar, runner-level numbers live in the card.** The top bar carries the race clock and the race's vs-planned; the bib card carries only what's true of the person currently running — time on leg, the leg's planned duration, and their ETA.
